...
{
   public class SckHttpRequest : WebRequest
   {
      ...
      private SckHttpResponse _response;
      ...
      private SckHttpRequest(Uri requestUri)
      {
      ...
      {
         return new SckHttpRequest(new Uri(requestUri));
      }

      public static new WebRequest Create(Uri requestUri)
      {
         return new SckHttpRequest(requestUri);
      }
      ...
      private SckHttpResponse InternalGetResponse()
      {
         ...
         return new SckHttpResponse(data, header);
      }
