...
{
   public class FastReaderWriterLock : IDisposable
   {
...
#endif
      // works only in 32-bit mode, any ideas on native 64-bit support? 
      static readonly bool UseNativeSRWLock = Utils.IsRunningOnVistaOrLater() && IntPtr.Size == 4;
